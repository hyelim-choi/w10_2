...
# CSV 파일 로드
url = 'https://raw.githubusercontent.com/hyelim-choi/w10_2/refs/heads/crawling_ChangWon/crawling_file_new/changwon_facilities_all.csv'
changwon_df = pd.read_csv(url)
